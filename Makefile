...
# Ahmed Abdellahi Abdat - Master EEEA - FSB 2024-2025
...
# Fichier de sortie
OUTPUT = rapport_pfe_abdat_ahmed.pdf
...
$(OUTPUT): $(MAIN).pdf
	@echo "Renommage du fichier de sortie..."
	@mv $(MAIN).pdf $(OUTPUT)
...
view: $(OUTPUT)
	...
	@xdg-open $(OUTPUT) 2>/dev/null || open $(OUTPUT) 2>/dev/null || echo "Impossible d'ouvrir le PDF automatiquement"
...
stats: $(OUTPUT)
	...
	@pdfinfo $(OUTPUT) | grep Pages | sed 's/[^0-9]*//'
