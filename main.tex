...
\hypersetup{
    ...
    pdfsubject={Projet de Fin d'Études - Master EEEA - FSB},
...
\definecolor{chapterColor}{RGB}{1,56,115}     % Bleu FSB
\definecolor{sectionColor}{RGB}{70,130,180}   % Bleu clair
...
\fancypagestyle{pfeStyle}{
  ...
  \fancyhf{}
  \fancyhead[L]{\fontsize{11}{11}\selectfont\nouppercase{\leftmark}}
  \fancyhead[R]{\fontsize{11}{11}\selectfont\nouppercase{\rightmark}}
  \fancyfoot[L]{\fontsize{10}{10}\selectfont FSB - Master EEEA}
  \fancyfoot[C]{\fontsize{10}{10}\selectfont 2024-2025}
  \fancyfoot[R]{\fontsize{10}{10}\selectfont Page \thepage}
}
...
\vspace{0.5cm}
\noindent\textbf{Keywords:} TinyML, Predictive maintenance, ESP32, Anomaly detection, K-means, Vibration analysis, Industry 4.0, Edge Computing
